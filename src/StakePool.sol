...
contract StakePool is Initializable, UUPSUpgradeable, Ownable, IStakePool {
    ...
    function undelegatePaused(address) external view returns (bool) {
        return ondoInstantManager.redeemPaused();
    }
        ...
        returns (uint256)
    {
        ...
        return ondoInstantManager.redeem(rwaAmount, _receivingToken, 0);
    }
